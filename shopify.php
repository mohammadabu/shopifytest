...
class Shopify {
	...
	private $db;
	private $api_key = "ebc6a819929a72c781ade97dcb80b9c0";
	private $password = "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";
	private $store = "techsfactorystory";
	...
	public function processCustomersMigration(){
		...
		$customers[0]['first_name'] = "mohammad";
		$customers[0]['last_name'] = "abusubhia";
		$customers[0]['email'] = "m.abusubhia@techsfactory.com";
